(() => {
    ...
    function rangeInit() {
        const rangeSliders = document.querySelectorAll(".filter-content__item_range");
        if (rangeSliders.length > 0) rangeSliders.forEach((rangeSlider => {
            const fromValue = rangeSlider.querySelector("[data-range-from]");
            const toValue = rangeSlider.querySelector("[data-range-to]");
            const range = rangeSlider.querySelector(".range");
            initialize(range, {
    ...
    function initSliders() {
        if (document.querySelector(".widget__slider")) new swiper_core_Swiper(".widget__slider", {
            ...
            navigation: {
                prevEl: ".widget .pagination-row__arr_prev",
                nextEl: ".widget .pagination-row__arr_next"
            },
            on: {}
        });
        if (document.querySelector(".main-section__slider")) new swiper_core_Swiper(".main-section__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".main-section .pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".main-section .pagination-row__arr_prev",
                nextEl: ".main-section .pagination-row__arr_next"
            },
            on: {}
        });
        if (document.querySelector(".filter-content__slider")) new swiper_core_Swiper(".filter-content__slider", {
            modules: [],
            simulateTouch: true,
            observer: true,
            observeParents: true,
        ...
        if (document.querySelector(".certificates__slider")) new swiper_core_Swiper(".certificates__slider", {
            ...
            navigation: {
                prevEl: ".certificates .pagination-row__arr_prev",
                nextEl: ".certificates .pagination-row__arr_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".clients__slider")) new swiper_core_Swiper(".clients__slider", {
            ...
            navigation: {
                prevEl: ".clients__slider .pagination-row__arr_prev",
                nextEl: ".clients__slider .pagination-row__arr_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2,
        ...
        if (document.querySelector(".proects__slider")) new swiper_core_Swiper(".proects__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            pagination: {
                el: ".proects__slider .pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".proects__slider .pagination-row__arr_prev",
                nextEl: ".proects__slider .pagination-row__arr_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
        ...
        if (document.querySelector(".home-news__slider")) new swiper_core_Swiper(".home-news__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".home-news__slider .pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".home-news__slider .pagination-row__arr_prev",
                nextEl: ".home-news__slider .pagination-row__arr_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
        ...
        if (document.querySelector(".product-reviews__slider")) new swiper_core_Swiper(".product-reviews__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            pagination: {
                el: ".product-reviews__slider .pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".product-reviews__slider .pagination-row__arr_prev",
                nextEl: ".product-reviews__slider .pagination-row__arr_next"
            },
            on: {}
        });
    }
...
***************************************************************************** */
    ...
    const catalogHeader = document.querySelector(".header__catalog");
    const companyHeader = document.querySelector(".header__company");
    const spollFilter = document.querySelector(".filter-block__click");
    const spollFast = document.querySelector(".filter-content__more-btn");
    const resetFilter = document.querySelector(".filter-content__reset");
    const topBtnGrid = document.querySelector(".top-catalog__btn._icon-grid");
    const topBtnLine = document.querySelector(".top-catalog__btn._icon-line");
    const catalog = document.querySelector(".catalog");
    const selTab = document.querySelector("#sel-tab");
    const productTabsBody = document.querySelectorAll(".product .tabs__body");
    ...
    window.addEventListener("load", (function(e) {
        if (spollFilter) spollFilter.addEventListener("click", (function(e) {
            spollFilter.disabled = true;
            setTimeout((() => {
                spollFilter.disabled = false;
            }), "800");
            if (spollFilter.classList.contains("_spoller-active")) spollFilter.textContent = "Показать фильтр"; else spollFilter.textContent = "Скрыть фильтр";
        }));
        if (spollFast) spollFast.addEventListener("click", (function(e) {
            spollFast.disabled = true;
            setTimeout((() => {
                spollFast.disabled = false;
            }), "800");
            if (spollFast.classList.contains("_spoller-active")) spollFast.textContent = "Показать ещё"; else spollFast.textContent = "Скрыть";
        }));
    }));
    if (topBtnGrid) topBtnGrid.addEventListener("click", (function(e) {
        if (catalog && !catalog.classList.contains("catalog_grid")) {
            catalog.classList.add("catalog_grid");
            if (topBtnLine.classList.contains("_active")) topBtnLine.classList.remove("_active");
            topBtnGrid.classList.add("_active");
        }
    }));
    if (topBtnLine) topBtnLine.addEventListener("click", (function(e) {
        if (catalog && catalog.classList.contains("catalog_grid")) {
            catalog.classList.remove("catalog_grid");
            if (topBtnGrid.classList.contains("_active")) topBtnGrid.classList.remove("_active");
            topBtnLine.classList.add("_active");
        }
    }));
    if (resetFilter) {
        const form = resetFilter.closest("form");
        resetFilter.addEventListener("click", (function(e) {
            form.reset();
        }));
    }
    if (selTab) document.addEventListener("selectCallback", (function(e) {
        if (e.detail.select == selTab) {
            console.log(selTab.value);
            if (productTabsBody.length > 0) {
                productTabsBody.forEach((tabBody => {
                    tabBody.hidden = true;
                }));
                productTabsBody[selTab.value - 1].hidden = false;
            }
        }
    }));
    const script_stickyBlock = document.querySelector(".fix-block");
    const buyButton = document.querySelector(".info-product");
    function addActiveClass() {
        script_stickyBlock.classList.add("_active");
    }
    function removeActiveClass() {
        script_stickyBlock.classList.remove("_active");
    }
    let prevScrollPosition = window.scrollY;
    window.addEventListener("scroll", (function() {
        if (script_stickyBlock && buyButton) {
            let scrollPosition = window.scrollY;
            let buyButtonPosition = buyButton.getBoundingClientRect().top + scrollPosition;
            if (scrollPosition > buyButtonPosition) addActiveClass(); else removeActiveClass();
            if (scrollPosition < prevScrollPosition) removeActiveClass();
            prevScrollPosition = scrollPosition;
        }
    }));
    function init() {
        const maps = document.querySelectorAll(".map");
        if (maps.length > 0) maps.forEach((mapBlock => {
            let center = mapBlock.dataset.coordinates.split(", ");
